...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/equipment").authenticated()
                .antMatchers(HttpMethod.GET, "/equipment/{id}").authenticated()
                .antMatchers(HttpMethod.GET, "/equipment/state").authenticated()
                .antMatchers(HttpMethod.GET, "/equipment/type").authenticated()
                .antMatchers(HttpMethod.GET, "/equipment/filter").authenticated()
                .antMatchers(HttpMethod.GET, "/equipment/search").authenticated()
