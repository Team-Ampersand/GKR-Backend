package Ampersand.GKR.global.error.exception.handler;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(GkrException.class)
    public ResponseEntity<ErrorMessage> handleComprehensiveException(HttpServletRequest request, GkrException e) {
